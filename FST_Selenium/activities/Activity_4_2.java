...
public class Activity4_2 {
    public static void main(String[] args) {
        ...
        WebElement firstName = driver.findElement(By.xpath("//input[@id = 'firstName']")).sendKeys("Sumanjali");
        WebElement lastName = driver.findElement(By.xpath("//input[@id = 'lastName']")).sendKeys("Reddy");
